...
- Adds one checked binding column and migration, neutral runtime create/control-class contract fields, a local control method, Codex adapter create/resume behavior, and two CLI commands.
...
- Reuses the pinned Codex 0.154.0 app-server protocol, existing runtime binding, managed account/socket routing, native child-process launch, delivery fences, and test harnesses. No dependency, generated-protocol, A2A wire-contract, service, or account-configuration change is introduced.
