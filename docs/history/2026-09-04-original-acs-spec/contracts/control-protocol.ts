...
export interface ControlMethodMap {
  ...
  "deliveries.resolveUnknown": {
    readonly params: {
      ...
      readonly resolution:
        | "accepted"
        | "not-accepted-and-retry"
        | "not-accepted-and-cancel";
...
export type ControlParams<M extends ControlMethod> =
  ControlMethodMap[M]["params"];

export type ControlResult<M extends ControlMethod> =
  ControlMethodMap[M]["result"];
